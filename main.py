...
def Findcolor():
    ...
    colors.itemconfig(id4,fill=color5)
...
Label(root,width=120,height=10,bg="#4272f9")
...
Label(frame,text="color finder",font="areial 25 bold",bg="white").place(x=100,y=20)
...
hex1=Label(colors,text="#b8255f",fg="#000",font="areial 12 bold",bg="white")
hex1.place(x=60,y=15)

hex2=Label(colors,text="#db4035",fg="#000",font="areial 12 bold",bg="white")
hex2.place(x=60,y=65)

hex3=Label(colors,text="#ff9933",fg="#000",font="areial 12 bold",bg="white")
hex3.place(x=60,y=115)

hex4=Label(colors,text="#fad000",fg="#000",font="areial 12 bold",bg="white")
hex4.place(x=60,y=165)

hex5=Label(colors,text="#afb83b",fg="#000",font="areial 12 bold",bg="white")
...
hex6=Label(colors2,text="#7ecc49",fg="#000",font="areial 12 bold",bg="white")
hex6.place(x=60,y=15)

hex7=Label(colors2,text="#299438",fg="#000",font="areial 12 bold",bg="white")
hex7.place(x=60,y=65)

hex8=Label(colors2,text="#6accbc",fg="#000",font="areial 12 bold",bg="white")
hex8.place(x=60,y=115)

hex9=Label(colors2,text="#158fad",fg="#000",font="areial 12 bold",bg="white")
hex9.place(x=60,y=165)

hex10=Label(colors2,text="#14aaf5",fg="#000",font="areial 12 bold",bg="white")
...
Button(selectimage,text="select image",width=12,height=1,font="areial 14 bold",command=showimage).place(x=10,y=300)
Button(selectimage,text="find colors",width=12,height=1,font="areial 14 bold",command=Findcolor).place(x=176,y=300)
